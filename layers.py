...
class GraphConvolution(Module):
    def __init__(self, in_features, graph_conv_units, edge_type_num, with_features=False, f_dim=0, dropout_rate=0.):
        ...
        self.in_features = in_features #in_features= self.atom_num_types
        self.graph_conv_units = graph_conv_units#graph_conv_units=[[128, 64], 128, [128, 64]]
        self.activation_f = torch.nn.Tanh()

        #edge_type_num= self.bond_num_types
